...
const ProductCardAdmin = ({ data, fetchProductData }) => {
  ...
  return (
    <div className='w-36 p-4 bg-white rounded shadow'>
      <div>
        <img
      ...
      <p className='text-ellipsis line-clamp-2 font-medium'>{data?.name || "No name"}</p>
      <p className='text-slate-400'>{data?.unit || "No unit"}</p>
